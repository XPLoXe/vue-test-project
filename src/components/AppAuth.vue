...
export default {
  ...
  computed: {
    ...
    //map the state into the component by using the map writable state function
    //the second argument "isOpen" accepts an array of state properties to map
    //...mapWritableState(useModalStore, ['isOpen'])
    //Alias: replace the 'isOpen' with an object:
    //"alias" : 'state' (name in the stores)
    ...mapWritableState(useModalStore, {
      modalVisibility: 'isOpen'
    })
  },
  methods: {}
  //components: { ErrorTypes }
}
</script>
